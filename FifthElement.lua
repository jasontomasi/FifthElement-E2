...
lightCreate(9, holoEntity(1):pos() + vec(0,0,100), ROCK1, 300, 400)
lightCreate(10, holoEntity(2):pos() + vec(0,0,100), ROCK2, 300, 400)
lightCreate(11, holoEntity(3):pos() + vec(0,0,100), ROCK3, 300, 400)
lightCreate(12, holoEntity(4):pos() + vec(0,0,100), ROCK4, 300, 400)
...
# TORUS RING
    ...
    holoMaterial(17, "Models/props_lab/monitorface")   # models/props_forest/waterfall001, models/props_c17/fisheyelens_dx60, Models/props_lab/monitorface, models/props_combine/tpballglow
...
if(E1 == 1) {
    ...
    lightCreate(81, holoEntity(5):pos() + vec(0,-35,25), ROCK1, 45, 20)
    lightCreate(82, holoEntity(5):pos() + vec(-35,0,25), ROCK1, 45, 20)
    lightCreate(83, holoEntity(5):pos() + vec(0,35,25), ROCK1, 45, 20)
    lightCreate(84, holoEntity(5):pos() + vec(35,0,25), ROCK1, 45, 20)
}
...
if(E2 == 1) {
    ...
    lightCreate(85, holoEntity(6):pos() + vec(0,-35,25), ROCK2, 45, 20)
    lightCreate(86, holoEntity(6):pos() + vec(-35,0,25), ROCK2, 45, 20)
    lightCreate(87, holoEntity(6):pos() + vec(0,35,25), ROCK2, 45, 20)
    lightCreate(88, holoEntity(6):pos() + vec(35,0,25), ROCK2, 45, 20)
}
...
if(E3 == 1) {
    ...
    lightCreate(89, holoEntity(7):pos() + vec(0,-35,25), ROCK3, 45, 20)
    lightCreate(90, holoEntity(7):pos() + vec(-35,0,25), ROCK3, 45, 20)
    lightCreate(91, holoEntity(7):pos() + vec(0,35,25), ROCK3, 45, 20)
    lightCreate(92, holoEntity(7):pos() + vec(35,0,25), ROCK3, 45, 20)
}
...
if(E4 == 1) {
    ...
    lightCreate(93, holoEntity(8):pos() + vec(0,-35,25), ROCK4, 45, 20)
    lightCreate(94, holoEntity(8):pos() + vec(-35,0,25), ROCK4, 45, 20)
    lightCreate(95, holoEntity(8):pos() + vec(0,35,25), ROCK4, 45, 20)
    lightCreate(96, holoEntity(8):pos() + vec(35,0,25), ROCK4, 45, 20)
}
